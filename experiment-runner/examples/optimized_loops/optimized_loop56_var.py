...
@measure_energy
def var_termination_loop(mock_function_call, median_of_five, mock_variable_assignment, arr):
    i = 0
    medians = []
    len_arr = len(arr)  # Cache the termination condition in a variable
...
var_termination_loop(mock_function_call, median_of_five, mock_variable_assignment, arr)
