...
@measure_energy
def early_termination_loop(arr, result, mock_function_call, mock_variable_assignment, arr_size):
...
early_termination_loop(arr, result, mock_function_call, mock_variable_assignment, len(arr))
