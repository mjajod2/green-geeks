...
@measure_energy
def unswitched_loop(mock_function_call, median_of_five, mock_variable_assignment, arr):
    i = 0
    medians = []
    len_arr = len(arr)  # Move the length calculation outside the loop
...
unswitched_loop(mock_function_call, median_of_five, mock_variable_assignment, arr)
