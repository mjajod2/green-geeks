...
@measure_energy
def early_termination_loop(neighbors, current_score, max_x, min_x, max_y, min_y, find_max, current_temp):
    next_state = None
...
early_termination_loop(neighbors, 50, 100, -100, 100, -100, True, 1000)
